...
- **Filtering**: Enable/disable multiple filters simultaneously (Lowpass, Highpass, Bandpass, Notch). Set filter order, low/high cutoff frequencies, and notch frequency. Detrend and Normalize checkboxes.
  - Filters are applied in sequence: Lowpass → Highpass → Bandpass → Notch.
  - You can combine filters (e.g. Highpass + Notch to remove noise and 50/60 Hz).
